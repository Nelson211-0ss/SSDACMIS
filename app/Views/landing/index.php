...
<div class="lp-screen">
  ...
  <div class="lp-screen__dots" aria-hidden="true"></div>
  ...
  <header class="lp-nav">
    <div class="lp-container lp-nav__inner">
      ...
      <a class="lp-btn lp-btn--white lp-btn--sm" href="<?= $base ?>/login">Sign In</a>
    </div>
  </header>
  ...
  <main class="lp-screen__main">
    <div class="lp-container lp-split">
      ...
      <div class="lp-split__visual" aria-hidden="true">
        <div class="lp-orb"><i class="bi bi-mortarboard-fill"></i></div>
        <div class="lp-chip lp-chip--1"><i class="bi bi-calendar-check-fill"></i></div>
        <div class="lp-chip lp-chip--2"><i class="bi bi-pencil-square"></i></div>
        <div class="lp-chip lp-chip--3"><i class="bi bi-cash-stack"></i></div>
        <div class="lp-chip lp-chip--4"><i class="bi bi-file-earmark-text-fill"></i></div>
        <div class="lp-chip lp-chip--5"><i class="bi bi-shield-lock-fill"></i></div>
      </div>
    </div>
  </main>
