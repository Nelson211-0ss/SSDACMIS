  ...
  <a href="<?= $base ?>/hods" class="kpi-card kpi-card--dash">
    ...
    <div class="kpi-card__body">
      ...
      <div class="kpi-card__delta kpi-card__delta--flat">
        <i class="bi bi-bookmark-star"></i> Dept. leads
      </div>
    </div>
  </a>
</div>
<div class="dash-kpi-grid__item">
  <a href="<?= $base ?>/bursars" class="kpi-card kpi-card--dash">
    ...
    <div class="kpi-card__body">
      ...
      <div class="kpi-card__delta kpi-card__delta--flat">
        <i class="bi bi-wallet2"></i> Finance team
      </div>
    </div>
  </a>
</div>
...
<div class="dash-kpi-grid__item">
  <a href="<?= $base ?>/teaching" class="kpi-card kpi-card--dash">
    ...
    <div class="kpi-card__body">
      <div class="kpi-card__label">Teaching</div>
      ...
      <div class="kpi-card__delta kpi-card__delta--<?= $unassignedCount > 0 ? 'down' : 'flat' ?>">
        ...
        <?php else: ?>
          <i class="bi bi-check2-circle"></i> All placed
        <?php endif; ?>
      </div>
    </div>
  </a>
